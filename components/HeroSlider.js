...
const slides = [
	{
		...
		quality: "4k Quality",
		description:
			"A la vanguardia del entretenimiento local y global, con la mejor tecnología de Claro para una experiencia sin límites.",
	},
	{
		id: 2,
...
const HeroSlider = () => {
	...
	return (
		<>
			<div className="video-area position-relative pt-100">
